...
export default function Introduction() {
    ...
    return (
        <div id="introduction">
            <p style={{ color: text }}>
                <span style={{ color: primary, fontWeight: "bold", fontSize: 34 }}>Mica</span> is a modern loyalty program platform designed to help businesses engage with their customers effectively.<br />
